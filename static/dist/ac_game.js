...
class ScoreBoard extends AcGameObject {
    constructor(playground) {
        ...
        this.win_img.src = "https://app8040.acapp.acwing.com.cn/static/image/playground/win.png";
        this.lose_img = new Image();
        this.lose_img.src = "https://app8040.acapp.acwing.com.cn/static/image/playground/lose.png";
    }
    start() {
    }
...
class Player extends AcGameObject {
    constructor(playground, x, y, radius, color, speed, character, username, photo) {
        ...
        if (this.character === "me") {
            ...
            this.fireball_img.src = "https://app8040.acapp.acwing.com.cn/static/image/playground/fireball.png";
            this.blink_coldtime = 5; // 单位：秒
            this.blink_img = new Image();
            this.blink_img.src = "https://app8040.acapp.acwing.com.cn/static/image/playground/blink.png";
        }
    }
    start() {
...
class MultiPlayerSocket {
    constructor(playground) {
        this.playground = playground;
        this.ws = new WebSocket("wss://app8040.acapp.acwing.com.cn/wss/multiplayer/");
        this.start();
    }
    start() {
        this.receive();
...
export { AcGame };
//# sourceMappingURL=ac_game.js.map